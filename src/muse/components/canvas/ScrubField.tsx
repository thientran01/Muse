...
export function ScrubField({
  ...
  return (
    ...
    <label
      ...
      className={`flex items-center gap-1 rounded-field border border-hairline-strong bg-surface px-1.5 py-1 text-field transition-colors focus-within:border-focus motion-reduce:transition-none ${
        disabled ? 'opacity-40' : ''
      }`}
    >
      <span
