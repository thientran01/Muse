    ...
    <>
      {pins.map((p) => (
        <button
          ...
          className="pointer-events-auto absolute z-10 flex h-4 min-w-4 items-center justify-center rounded-full bg-accent px-1 text-badge font-semibold leading-none text-white shadow ring-1 ring-fg transition duration-[120ms] ease-[cubic-bezier(0.16,1,0.3,1)] hover:scale-110 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60 motion-reduce:transition-none motion-reduce:active:scale-100"
        >
          {p.n}
        </button>
      ))}
