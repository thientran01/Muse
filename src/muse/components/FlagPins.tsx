    ...
    <>
      {pins.map((p) => (
        <button
          ...
          className="pointer-events-auto absolute z-10 flex h-4 min-w-4 items-center justify-center rounded-full bg-accent px-1 text-[9px] font-semibold text-white shadow ring-2 ring-fg outline-none transition duration-[120ms] ease-out-strong hover:scale-110 focus-visible:ring-2 focus-visible:ring-accent/60 motion-reduce:transition-none"
        >
          {p.n}
        </button>
      ))}
