...
// api.ts resolves its demo-mode flag when it loads, so the host global has to be
// in place BEFORE the first import. (After the lazy-config change this is merely
// sufficient rather than required — either way it is the correct setup.)
