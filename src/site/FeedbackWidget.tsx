...
export function FeedbackWidget() {
  ...
  return (
    <div data-muse-ui className="fixed bottom-5 left-5 z-[9998] font-sans">
      {open ? (
        <div className="w-[320px] overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-xl ring-1 ring-black/5">
          ...
          {status === 'sent' ? (
            <div className="px-4 py-6 text-center">
              ...
              <button
                ...
                className="mt-3 text-[13px] font-medium text-[#7f2f2f] hover:underline"
              >
                Send another
              </button>
            </div>
            ...
            <div className="px-4 py-3.5">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-lg border border-zinc-200 px-3 py-2 text-[14px] text-zinc-800 outline-none transition-colors placeholder:text-zinc-400 focus:border-[#7f2f2f]/50 focus:ring-2 focus:ring-[#7f2f2f]/10"
              />
              ...
              <input
                ...
                className="mt-2 w-full rounded-lg border border-zinc-200 px-3 py-2 text-[14px] text-zinc-800 outline-none transition-colors placeholder:text-zinc-400 focus:border-[#7f2f2f]/50 focus:ring-2 focus:ring-[#7f2f2f]/10"
              />
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-4 py-2.5 text-sm font-medium text-zinc-700 shadow-lg ring-1 ring-black/5 transition-colors hover:bg-zinc-50"
        >
